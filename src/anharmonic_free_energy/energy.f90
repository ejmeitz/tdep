module energy
    ...
    subroutine perturbative_anharmonic_free_energy(p, fct, fcf, qp, dr, temperature, free_energy_thirdorder, free_energy_fourthorder, &
        ...
        real(r8), dimension(:, :), allocatable, intent(out), optional :: en3_out, en4_out
        ...
        finalize: block
            ...
            ! Check if we need to return en3 or en4
            if (present(en3_out)) then
                en3_out = en3
            end if

            if (present(en4_out) .and. fourthorder) then
                en4_out = en4
            end if
